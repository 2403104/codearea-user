...
const ProblemWrapper = () => {
    ...
    const { getTestCases, problem } = context;
    ...
    useEffect(() => {
        if (problemData?.title && problemData?._id) {
            getTestCases(problemData.title, problemData._id);
        }
    }, [problemData, getTestCases]);
            ...
            >
                <div style={{ height: '100%', overflowY: 'auto', padding: '0 10px' }}>
                    ...
                    {problemData ? (
                        ...
                        <div className="p-3">Loading problem data...</div>
                    )}
                </div>
                <div style={{ height: '100%', overflowY: 'auto', padding: '0 10px' }}>
                    <CodeArea />
